...
namespace Farmacie.App
{
    ...
    sealed partial class App : Application
    {
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs args)
        {
            ...
            //var menuFunzioni = new MainFunctions();
            //_rootFrame.Navigate(typeof(ItemsPage), sampleData.ItemGroups);
            //_rootFrame.Navigate(typeof(ItemsPage), menuFunzioni.GetAllFunctions());
            //var _rootFrame = IoC.Resolve<Frame>();
            //_rootFrame.Navigate(typeof(ItemsPage), menuFunzioni.MacroGruppi);
