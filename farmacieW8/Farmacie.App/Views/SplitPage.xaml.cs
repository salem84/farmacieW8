...
namespace Farmacie.App.Views
{
    ...
    /// </summary>
    public sealed partial class SplitPage : Farmacie.App.Common.LayoutAwarePage
    {
        IRegioniService regioniService;

        public SplitPage()
        {
            this.regioniService = IoC.Resolve<IRegioniService>();
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            this.DefaultViewModel["Regioni"] = regioniService.GetRegioni();
            ...
            if (!this.UsingLogicalPageNavigation()) this.regioniViewSource.View.MoveCurrentToFirst();
        }
        ...
        void ItemListView_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            Regione regione = itemListView.SelectedItem as Regione;
            bingMap.Center = new Bing.Maps.Location(regione.Latitudine, regione.Longitudine);
        }
